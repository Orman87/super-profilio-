...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (musicToggle && controlPanel) {
        ...
        document.addEventListener("click", function(e) {
            if (!musicToggle.contains(e.target) && !controlPanel.contains(e.target)) {
    ...
    async function countVisitor() {
        ...
        try {
            // Try to use CounterAPI if available
    ...
    // Observe when visitor card comes into view
    if (visitorCard) {
        ...
        console.error("❌ .visitor-card not found");
    }
